package exerciseandroidsimpleactivity.exerciseandroidsimpleactivity;
...
public class TrialSplashScreen extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen.this, exerciseandroidsimpleactivity.MainActivity.class);
